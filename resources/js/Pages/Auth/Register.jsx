          ...
          <div className="grid w-full grid-cols-1 overflow-hidden rounded-3xl bg-white/5 shadow-2xl ring-1 ring-white/10 backdrop-blur xl:grid-cols-2">
            ...
            <div className="relative p-8 sm:p-12">
              ...
              <p className="mt-2 text-sm text-white/70">
                Register to save favorites and view personalized offers.
              </p>
              ...
              <form onSubmit={submit} className="mt-8 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white placeholder:text-white/35 outline-none transition focus:border-yellow-300/40 focus:bg-white/10"
                    placeholder="Your name"
                    autoComplete="name"
                  />
                  {errors.name && (
                    <div className="mt-2 text-sm text-red-300">{errors.name}</div>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.password && (
                    <div className="mt-2 text-sm text-red-300">{errors.password}</div>
                  )}
                </div>
                ...
                <div className="flex items-center justify-center text-sm text-white/70">
                  ...
                  <Link
                    href="/login"
                    className="ml-2 font-semibold text-yellow-200 underline-offset-4 hover:underline"
                  >
                    Log in
                  </Link>
                </div>
            ...
            <div className="relative hidden overflow-hidden xl:block">
              ...
              <div className="relative flex h-full flex-col justify-end p-10">
                <div className="rounded-2xl bg-white/10 p-4 text-sm text-white/80 ring-1 ring-white/10 backdrop-blur">
                  ...
                  Use your university email for faster account recovery.
                </div>
              </div>
            </div>
          </div>
